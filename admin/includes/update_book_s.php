<?php
    ...
    $query = "SELECT * FROM cerute WHERE id_carte_ceruta = {$p_id_u}";
    ...
    if(isset($_POST['update_book'])){
        ...
        $query = "UPDATE cerute SET titlu = '{$carte_titlu}', autor = '{$carte_autor}', imagine = '{$carte_imagine}', ";
        $query .= "tags = '{$carte_tags}' WHERE id_carte_ceruta= {$p_id_u}";
